 ...
 * @author leonaci
 */
@:pythonImport('chainer.initializers.constant', 'Identity') extern class Identity {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?scale:Dynamic, ?dtype:Dynamic):Dynamic;
	public function __init_subclass__():Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?scale:Dynamic, ?dtype:Dynamic):Void;
	/**
		Return self<=value.
	**/
