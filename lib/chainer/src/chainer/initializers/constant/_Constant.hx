 ...
 * @author leonaci
 */
@:pythonImport('chainer.initializers.constant', '_Constant') extern class _Constant {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?dtype:Dynamic):Dynamic;
	public function __init_subclass__():Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?dtype:Dynamic):Void;
	/**
		Return self<=value.
	**/
