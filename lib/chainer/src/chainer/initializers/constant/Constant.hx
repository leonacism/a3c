 ...
 * @author leonaci
 */
@:pythonImport('chainer.initializers.constant', 'Constant') extern class Constant {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(fill_value:Dynamic, ?dtype:Dynamic):Dynamic;
	public function __init_subclass__():Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(fill_value:Dynamic, ?dtype:Dynamic):Void;
	/**
		Return self<=value.
	**/
