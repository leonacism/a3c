 ...
 * @author leonaci
 */
@:pythonImport('chainer.utils.type_check', 'TypeInfo') extern class TypeInfo {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(shape:Dynamic, dtype:Dynamic):Dynamic;
	public function __init_subclass__() : Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(shape:Dynamic, dtype:Dynamic):Void;
	/**
		Return self<=value.
	**/
