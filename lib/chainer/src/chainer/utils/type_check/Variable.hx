 ...
 * @author leonaci
 */
@:pythonImport('chainer.utils.type_check', 'Variable') extern class Variable {
	...
	**/
	@:native("__init__")
	public function ___init__(value:Dynamic, name:Dynamic):Dynamic;
	public function __init_subclass__() : Dynamic;
	static public function __invert__(x:Dynamic) : Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(value:Dynamic, name:Dynamic):Void;
	/**
		Return self<=value.
	**/
