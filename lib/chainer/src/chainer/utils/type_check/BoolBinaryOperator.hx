 ...
 * @author leonaci
 */
@:pythonImport('chainer.utils.type_check', 'BoolBinaryOperator') extern class BoolBinaryOperator {
	...
	**/
	@:native("__init__")
	public function ___init__(lhs:Dynamic, rhs:Dynamic, exp:Dynamic, inv:Dynamic, func:Dynamic):Dynamic;
	public function __init_subclass__() : Dynamic;
	static public function __invert__(x:Dynamic) : Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(lhs:Dynamic, rhs:Dynamic, exp:Dynamic, inv:Dynamic, func:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	public function expect() : Dynamic;
}