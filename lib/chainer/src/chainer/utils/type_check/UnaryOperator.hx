 ...
 * @author leonaci
 */
@:pythonImport('chainer.utils.type_check', 'UnaryOperator') extern class UnaryOperator {
	...
	**/
	@:native("__init__")
	public function ___init__(priority:Dynamic, term:Dynamic, exp:Dynamic, func:Dynamic):Dynamic;
	public function __init_subclass__() : Dynamic;
	static public function __invert__(x:Dynamic) : Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(priority:Dynamic, term:Dynamic, exp:Dynamic, func:Dynamic):Void;
	/**
		Return self<=value.
	**/
