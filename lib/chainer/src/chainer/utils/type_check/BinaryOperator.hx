 ...
 * @author leonaci
 */
@:pythonImport('chainer.utils.type_check', 'BinaryOperator') extern class BinaryOperator {
	...
	**/
	@:native("__init__")
	public function ___init__(priority:Dynamic, lhs:Dynamic, rhs:Dynamic, exp:Dynamic, func:Dynamic, ?right_associative:Dynamic):Dynamic;
	public function __init_subclass__() : Dynamic;
	static public function __invert__(x:Dynamic) : Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(priority:Dynamic, lhs:Dynamic, rhs:Dynamic, exp:Dynamic, func:Dynamic, ?right_associative:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	public function _eval_left() : Dynamic;
	public function _eval_right() : Dynamic;
	/**
