 ...
 * @author leonaci
 */
@:pythonImport('chainer.utils.type_check', 'Call') extern class Call {
	...
	**/
	@:native("__init__")
	public function ___init__(obj:Dynamic, args:Dynamic):Dynamic;
	public function __init_subclass__() : Dynamic;
	static public function __invert__(x:Dynamic) : Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(obj:Dynamic, args:Dynamic):Void;
	/**
		Return self<=value.
	**/
