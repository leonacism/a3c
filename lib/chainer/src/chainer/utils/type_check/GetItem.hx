 ...
 * @author leonaci
 */
@:pythonImport('chainer.utils.type_check', 'GetItem') extern class GetItem {
	...
	**/
	@:native("__init__")
	public function ___init__(obj:Dynamic, key:Dynamic):Dynamic;
	public function __init_subclass__() : Dynamic;
	static public function __invert__(x:Dynamic) : Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(obj:Dynamic, key:Dynamic):Void;
	/**
		Return self<=value.
	**/
