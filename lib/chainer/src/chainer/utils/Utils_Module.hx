 ...
 * @author leonaci
 */
@:pythonImport('chainer.utils') extern class Utils_Module {
	...
	**/
	static public function experimental(api_name:Dynamic) : Dynamic;
	static public function force_array(x:Dynamic, ?dtype:Dynamic) : Dynamic;
	static public function force_type(dtype:Dynamic, value:Dynamic) : Dynamic;
	/**
