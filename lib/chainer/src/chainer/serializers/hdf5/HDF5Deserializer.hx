 ...
 * @author leonaci
 */
@:pythonImport('chainer.serializers.hdf5', 'HDF5Deserializer') extern class HDF5Deserializer {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(group:Dynamic, ?strict:Dynamic) : Dynamic;
	public function __init_subclass__():Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(group:Dynamic, ?strict:Dynamic) : Void;
	/**
		Return self<=value.
	**/
