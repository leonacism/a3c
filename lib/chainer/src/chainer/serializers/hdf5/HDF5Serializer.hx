 ...
 * @author leonaci
 */
@:pythonImport('chainer.serializers.hdf5', 'HDF5Serializer') extern class HDF5Serializer {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(group:Dynamic, ?compression:Dynamic) : Dynamic;
	public function __init_subclass__():Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(group:Dynamic, ?compression:Dynamic) : Void;
	/**
		Return self<=value.
	**/
	...
	**/
	public function save(obj:Dynamic) : Dynamic;
}