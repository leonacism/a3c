 ...
 * @author leonaci
 */
@:pythonImport('chainer.serializers.npz', 'NpzDeserializer') extern class NpzDeserializer {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(npz:Dynamic, ?path:Dynamic, ?strict:Dynamic) : Dynamic;
	public function __init_subclass__():Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(npz:Dynamic, ?path:Dynamic, ?strict:Dynamic) : Void;
	/**
		Return self<=value.
	**/
