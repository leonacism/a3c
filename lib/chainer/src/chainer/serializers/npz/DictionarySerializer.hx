 ...
 * @author leonaci
 */
@:pythonImport('chainer.serializers.npz', 'DictionarySerializer') extern class DictionarySerializer {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?target:Dynamic, ?path:Dynamic) : Dynamic;
	public function __init_subclass__():Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?target:Dynamic, ?path:Dynamic) : Void;
	/**
		Return self<=value.
	**/
