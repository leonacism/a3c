package chainer.links.caffe.caffe_function;

/**
 * ...
 * @author leonaci
 */
@:pythonImport('chainer.links.caffe.caffe_function', 'CaffeFunction') extern class CaffeFunction {
	/**
	...
	**/
	public function __call__(inputs:Dynamic, outputs:Dynamic, ?disable:Dynamic, ?kwargs:python.KwArgs<Dynamic>) : Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(model_path:Dynamic):Dynamic;
	public function __init_subclass__():Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(model_path:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	public function _add_layer(layer:Dynamic) : Dynamic;
	public function _setup_batchnorm(layer:Dynamic) : Dynamic;
	public function _setup_concat(layer:Dynamic) : Dynamic;
	public function _setup_convolution(layer:Dynamic) : Dynamic;
	public function _setup_data(layer:Dynamic) : Dynamic;
	public function _setup_dropout(layer:Dynamic) : Dynamic;
	public function _setup_eltwise(layer:Dynamic) : Dynamic;
	public function _setup_inner_product(layer:Dynamic) : Dynamic;
	public function _setup_lrn(layer:Dynamic) : Dynamic;
	public function _setup_pooling(layer:Dynamic) : Dynamic;
	public function _setup_relu(layer:Dynamic) : Dynamic;
	public function _setup_scale(layer:Dynamic) : Dynamic;
	public function _setup_slice(layer:Dynamic) : Dynamic;
	public function _setup_softmax(layer:Dynamic) : Dynamic;
	public function _setup_softmax_with_loss(layer:Dynamic) : Dynamic;
	public function _setup_split(layer:Dynamic) : Dynamic;
	/**
