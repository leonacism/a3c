 ...
 * @author leonaci
 */
@:pythonImport('chainer.links.caffe.caffe_function', '_Blob') extern class _Blob {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(blob:Dynamic):Dynamic;
	public function __init_subclass__():Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(blob:Dynamic):Void;
	/**
		Return self<=value.
	**/
