 ...
 * @author leonaci
 */
@:pythonImport('chainer.links.activation.swish', 'Swish') extern class Swish {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(beta_shape:Dynamic, ?beta_init:Dynamic):Dynamic;
	public function __init_subclass__():Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(beta_shape:Dynamic, ?beta_init:Dynamic):Void;
	/**
		Return self<=value.
	**/
