package chainer.links.activation.prelu;

/**
 * ...
 * @author leonaci
 */
@:pythonImport('chainer.links.activation.prelu', 'PReLU') extern class PReLU {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?shape:Dynamic, ?init:Dynamic):Dynamic;
	public function __init_subclass__():Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?shape:Dynamic, ?init:Dynamic):Void;
	/**
		Return self<=value.
	**/
