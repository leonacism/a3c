 ...
 * @author leonaci
 */
@:pythonImport('chainer.optimizer', 'WeightDecay') extern class WeightDecay {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(rate:Dynamic) : Dynamic;
	public function __init_subclass__():Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(rate:Dynamic) : Void;
	/**
		Return self<=value.
	**/
