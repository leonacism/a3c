 ...
 * @author leonaci
 */
@:pythonImport('chainer.optimizer', 'HyperparameterProxy') extern class HyperparameterProxy {
	/**
	...
	**/
	...
	public function __get__(obj:Dynamic, ?type:Dynamic):Dynamic;
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(attr_name:Dynamic) : Dynamic;
	public function __init_subclass__():Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(attr_name:Dynamic) : Void;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	public function __set__(obj:Dynamic, value:Dynamic) : Dynamic;
	/**
