 ...
 * @author leonaci
 */
@:pythonImport('chainer.optimizer', 'GradientHardClipping') extern class GradientHardClipping {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(lower_bound:Dynamic, upper_bound:Dynamic) : Dynamic;
	public function __init_subclass__():Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(lower_bound:Dynamic, upper_bound:Dynamic) : Void;
	/**
		Return self<=value.
	**/
