 ...
 * @author leonaci
 */
@:pythonImport('chainer.optimizer', 'GradientClipping') extern class GradientClipping {
	/**
	...
	**/
	...
	public function __call__(opt:Dynamic) : Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(threshold:Dynamic) : Dynamic;
	public function __init_subclass__():Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(threshold:Dynamic) : Void;
	/**
		Return self<=value.
	**/
