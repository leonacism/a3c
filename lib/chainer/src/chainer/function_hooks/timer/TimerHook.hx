package chainer.function_hooks.timer;

/**
 * ...
 * @author leonaci
 */
@:pythonImport('chainer.function_hooks.timer', 'TimerHook') extern class TimerHook {
	/**
	...
	**/
	public function _humanized_time(second:Dynamic) : Dynamic;
	...
	**/
	...
	public function total_time() : Dynamic;
}