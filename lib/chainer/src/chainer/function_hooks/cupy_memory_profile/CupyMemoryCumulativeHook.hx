 ...
 * @author leonaci
 */
@:pythonImport('chainer.function_hooks.cupy_memory_profile', 'CupyMemoryCumulativeHook') extern class CupyMemoryCumulativeHook {
	/**
	...
	**/
	...
	public function alloc_preprocess(?kwargs:python.KwArgs<Dynamic>) : Dynamic;
	public function malloc_preprocess(?kwargs:python.KwArgs<Dynamic>) : Dynamic;
}