 ...
 * @author leonaci
 */
@:pythonImport('chainer.link', 'ChainList') extern class ChainList {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?links:python.VarArgs<Dynamic>):Dynamic;
	public function __init_subclass__():Dynamic;
	public function __iter__() : Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?links:python.VarArgs<Dynamic>):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	public function append(link:Dynamic) : Dynamic;
	/*
		Registers a child link and adds it to the tail of the list.
        Args:
            link (Link): The link object to be registered.
	**/
	public function add_link(link:Dynamic) : Dynamic;
	/*
