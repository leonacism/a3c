 ...
 * @author leonaci
 */
@:pythonImport('chainer.link', 'Chain') extern class Chain {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?links:python.KwArgs<Dynamic>):Dynamic;
	public function __init_subclass__():Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?links:python.KwArgs<Dynamic>):Void;
	/**
		Return self<=value.
	**/
