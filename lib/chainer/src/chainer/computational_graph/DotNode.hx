 ...
 * @author leonaci
 */
@:pythonImport('chainer.computational_graph', 'DotNode') extern class DotNode {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(node:Dynamic, ?attribute:Dynamic, ?show_name:Dynamic):Dynamic;
	public function __int__() : Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(node:Dynamic, ?attribute:Dynamic, ?show_name:Dynamic):Void;
	/**
		Return self<=value.
	**/
