 ...
 * @author leonaci
 */
@:pythonImport('chainer.functions.array.broadcast', 'BroadcastTo') extern class BroadcastTo {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(shape:Dynamic):Dynamic;
	public function __init_subclass__() : Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(shape:Dynamic):Void;
	/**
		Return self<=value.
	**/
