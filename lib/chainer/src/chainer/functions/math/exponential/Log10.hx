 ...
 * @author leonaci
 */
@:pythonImport('chainer.functions.math.exponential', 'Log10') extern class Log10 {
	...
	**/
	@:native("__init__")
	public function ___init__(?axis:Dynamic, ?keepdims:Dynamic):Dynamic;
	...
	**/
	...
	static public var keepdims : Dynamic;
