 ...
 * @author leonaci
 */
@:pythonImport('chainer.functions.activation.clipped_relu', 'ClippedReLUGrad') extern class ClippedReLUGrad {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(x:Dynamic, z:Dynamic):Dynamic;
	public function __init_subclass__() : Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(x:Dynamic, z:Dynamic):Void;
	/**
		Return self<=value.
	**/
