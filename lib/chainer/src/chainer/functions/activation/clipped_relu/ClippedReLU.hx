 ...
 * @author leonaci
 */
@:pythonImport('chainer.functions.activation.clipped_relu', 'ClippedReLU') extern class ClippedReLU {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(z:Dynamic):Dynamic;
	public function __init_subclass__() : Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(z:Dynamic):Void;
	/**
		Return self<=value.
	**/
