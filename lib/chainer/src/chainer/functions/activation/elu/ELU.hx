 ...
 * @author leonaci
 */
@:pythonImport('chainer.functions.activation.elu', 'ELU') extern class ELU {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?alpha:Dynamic):Dynamic;
	public function __init_subclass__() : Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?alpha:Dynamic):Void;
	/**
		Return self<=value.
	**/
