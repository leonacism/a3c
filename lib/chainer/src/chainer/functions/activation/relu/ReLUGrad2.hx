 ...
 * @author leonaci
 */
@:pythonImport('chainer.functions.activation.relu', 'ReLUGrad2') extern class ReLUGrad2 {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(b:Dynamic):Dynamic;
	public function __init_subclass__() : Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(b:Dynamic):Void;
	/**
		Return self<=value.
	**/
