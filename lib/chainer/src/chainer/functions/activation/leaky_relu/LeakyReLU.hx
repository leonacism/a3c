 ...
 * @author leonaci
 */
@:pythonImport('chainer.functions.activation.leaky_relu', 'LeakyReLU') extern class LeakyReLU {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?slope:Dynamic):Dynamic;
	public function __init_subclass__() : Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?slope:Dynamic):Void;
	/**
		Return self<=value.
	**/
