 ...
 * @author leonaci
 */
@:pythonImport('chainer.functions.activation.leaky_relu', '_LeakyReLUGrad') extern class _LeakyReLUGrad {
	...
	**/
	@:native("__init__")
	public function ___init__(x:Dynamic, y:Dynamic, slope:Dynamic):Dynamic;
	public function __init_subclass__() : Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(x:Dynamic, y:Dynamic, slope:Dynamic):Void;
	/**
		Return self<=value.
	**/
