 ...
 * @author leonaci
 */
@:pythonImport('chainer.functions.activation.log_softmax', 'LogSoftmaxGrad') extern class LogSoftmaxGrad {
	...
	**/
	@:native("__init__")
	public function ___init__(x_xp:Dynamic, x_shape:Dynamic, x_dtype:Dynamic):Dynamic;
	public function __init_subclass__() : Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(x_xp:Dynamic, x_shape:Dynamic, x_dtype:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	public function backward(indexes:Dynamic, ggx:Dynamic) : Dynamic;
	/**
