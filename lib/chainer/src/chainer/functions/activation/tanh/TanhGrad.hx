 ...
 * @author leonaci
 */
@:pythonImport('chainer.functions.activation.tanh', 'TanhGrad') extern class TanhGrad {
	...
	**/
	@:native("__init__")
	public function ___init__(x:Dynamic):Dynamic;
	public function __init_subclass__() : Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(x:Dynamic):Void;
	/**
		Return self<=value.
	**/
