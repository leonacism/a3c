 ...
 * @author leonaci
 */
@:pythonImport('chainer.functions.activation.tanh', 'Tanh') extern class Tanh {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?beta:Dynamic):Dynamic;
	public function __init_subclass__() : Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?beta:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	public function backward(indexes:Dynamic, grad_outputs:Dynamic) : Dynamic;
	/**
	...
	**/
	public function forward(x:Dynamic) : Dynamic;
	/**
        ...
        .. warning::
            ...
            return value must be a tuple even if it returns only one array.
	**/
	public function forward_cpu(x:Dynamic) : Dynamic;
	/**
        ...
        .. warning::
            ...
            return value must be a tuple even if it returns only one array.
	**/
	public function forward_gpu(x:Dynamic) : Dynamic;
	/**
