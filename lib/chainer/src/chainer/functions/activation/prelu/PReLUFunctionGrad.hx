 ...
 * @author leonaci
 */
@:pythonImport('chainer.functions.activation.prelu', 'PReLUFunctionGrad') extern class PReLUFunctionGrad {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(cond:Dynamic, reduce_axes:Dynamic, extended_shape:Dynamic):Dynamic;
	public function __init_subclass__() : Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(cond:Dynamic, reduce_axes:Dynamic, extended_shape:Dynamic):Void;
	/**
		Return self<=value.
	**/
