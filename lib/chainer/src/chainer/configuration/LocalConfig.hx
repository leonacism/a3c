 ...
 * @author leonaci
 */
@:pythonImport('chainer.configuration', 'LocalConfig') extern class LocalConfig {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(global_config:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(global_config:Dynamic):Void;
	/**
		Return self<=value.
	**/
