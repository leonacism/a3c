 ...
 * @author leonaci
 */
@:pythonImport('chainer.gradient_check', '_GradientSetter') extern class _GradientSetter {
	...
	**/
	@:native("__init__")
	public function ___init__(grad:Dynamic):Dynamic;
	public function __init_subclass__() : Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(grad:Dynamic):Void;
	/**
		Return self<=value.
	**/
