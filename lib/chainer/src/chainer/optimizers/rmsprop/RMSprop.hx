 ...
 * @author 
 */
@:pythonImport('chainer.optimizers.rmsprop', 'RMSprop') extern class RMSprop {
	/**
		RMSprop optimizer.
	...
	**/
	@:native("__init__")
	public function ___init__(?lr:Dynamic, ?alpha:Dynamic, ?eps:Dynamic) : Dynamic;
	public function __init_subclass__():Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?lr:Dynamic, ?alpha:Dynamic, ?eps:Dynamic) : Void;
	/**
		Return self<=value.
	**/
