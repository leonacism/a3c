 ...
 * @author leonaci
 */
@:pythonImport('chainer.optimizers.adam', 'AdamRule') extern class AdamRule {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?parent_hyperparam:Dynamic, ?alpha:Dynamic, ?beta1:Dynamic, ?beta2:Dynamic, ?eps:Dynamic, ?eta:Dynamic, ?weight_decay_rate:Dynamic, ?amsgrad:Dynamic) : Dynamic;
	public function __init_subclass__():Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?parent_hyperparam:Dynamic, ?alpha:Dynamic, ?beta1:Dynamic, ?beta2:Dynamic, ?eps:Dynamic, ?eta:Dynamic, ?weight_decay_rate:Dynamic, ?amsgrad:Dynamic) : Void;
	/**
		Return self<=value.
	**/
